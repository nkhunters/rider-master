...
export function searchpropertyrequest() {
  return {
    type: SEARCH_PROPERTY_RESPONSE
  }
}
export function searchpropertyrequestsuccess(data) {
  return {
    type: SEARCH_PROPERTY_SUCCESS,
    payload: data
  }
}
export function searchpropertyrequestfailed(data) {
  return {
    type: SEARCH_PROPERTY_FAILED,
    payload: data
  }
}
...
export function currentLocation() {
  return (dispatch, getState) => {
    navigator.geolocation.getCurrentPosition(location => {
      ...
      alert('Please enable location in app settings');
    });
...
export function allPropertyList(propertyArray) {
  return {
    type: SET_ALL_PROPERTY_DATA,
...
export function getAllProperties(jwtAccessToken) {
  return (dispatch, getState) => {
    fetch(`${config.serverSideUrl}:${config.port}/api/users/property`, {
      ...
      .then(resp => resp.json())
      .then(property => {
        dispatch(allPropertyList(property))
      }).catch(e => console.log(e))
  };
}
export function searchproperty(jwtAccessToken, querystring) {
  return (dispatch, getState) => {
    ...
    fetch(`${config.serverSideUrl}:${config.port}/api/users/property`, {
      ...
      .then(resp => resp.json())
      .then(property => {
        dispatch(searchpropertyrequestsuccess(property))
      }).catch(e => console.log(e))
  }
}

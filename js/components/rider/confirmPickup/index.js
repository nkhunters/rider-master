...
import RiderCount from '../../../components/rider/riderCount'
...
class confirmPickup extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      destCity: "",
      riderCount: 1,
      isShowRiderCountView: false,

    };
  }

  async componentDidMount() {
	  //console.log('sdfsddddddddd');
  ...
  async handlePress() {    
    ...
    this.props.tripRequest.capacity = this.state.riderCount;
  ...
  render() {
    return (
      <View pointerEvents="box-none" style={{ flex: 1 }}>
              ...
              <View>
                ...
                >
                  ...
                  <Button
                    ...
                    transparent
                    style={{ flex: 1, paddingLeft: 0, fontSize: 16 }}
                  >
        ...
        {
          this.state.isShowRiderCountView && <RiderCount 
          ...
          onAdd={()=>{
            this.setState({
              riderCount: this.state.riderCount+1
            })
          }} 
          onRemove={()=>{
            if(this.state.riderCount > 1){
            this.setState({
              riderCount: this.state.riderCount-1
            })
          }

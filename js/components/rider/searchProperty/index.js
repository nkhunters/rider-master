...
class searchProperty extends Component {
    ...
    _renderSearchProperty() {
        ...
        if (searchprop.length != 0) {
            return (searchprop).map((items, index) => (
                <MapView.Marker key={index} coordinate={{ latitude: items.mapCoordinates.coordinates[1], longitude: items.mapCoordinates.coordinates[0] }}>
                ...
                <View style={{ maxHeight: 200, backgroundColor: "#fff", paddingBottom: 15, overflow: "scroll", borderWidth: 1, borderColor: "#CBCBD3" }}>
                    <View style={{ backgroundColor: "transparent", overflow: "scroll" }}>
                        ...
                        {this.state.loading == true ? <Spinner /> :
                            <View style={{ backgroundColor: "transparent", maxHeight: 155 }}>

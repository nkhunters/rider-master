...
class RootView extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    if (this.props.tripRequestStatus === "request") {
      ...
      this.props.changePageStatus("confirmPropertyRide");
    } else {
      this.props.syncDataAsync(this.props.jwtAccessToken);
    }

    if (this.props.destLoc[0] !== undefined) {
      if (this.props.pageStatus === "confirmRide" || this.props.pageStatus === "confirmPropertyRide") {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
	...
	if(nextProps.advertisments){
		console.log('HERE')
		console.log(nextProps.advertisments)
	}*/
  }

  setDestMap() {
    if (
      (this.props.pageStatus === "confirmRide" || this.props.pageStatus === "confirmPropertyRide") &&
      this.props.destLoc[0] !== undefined
    ) {
